...
void Menu::update(Game_States * state, sf::RenderWindow * window){
	...
	if( start_b.check(sf::Mouse::getPosition(*window).x, 
                      sf::Mouse::getPosition(*window).y, 
                      sf::Mouse::isButtonPressed(sf::Mouse::Left)) ) 
        *state = IN_GAME;
	if( quit_b.check(sf::Mouse::getPosition(*window).x, 
                     sf::Mouse::getPosition(*window).y, 
                     sf::Mouse::isButtonPressed(sf::Mouse::Left)) ) 
        window->Close();
}
...
void InGame_Menu::update(Game_States * state, sf::RenderWindow * window){
